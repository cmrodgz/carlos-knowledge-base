...
A similar category is [[example-folder-02/example-folder-01/example-category-02/example-category-01/index| Category 01]], which also uses the `index.md` method to specify a category page title and descriptive text.